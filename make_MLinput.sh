...
# ./make_MLinput.sh $( pwd ) $( pwd ) $( pwd )/output 5 1000 10 3 0.001 0.005 0.01 0.015 0.02 0.025 0.03 0.035 0.04 0.05
...
do
	...
	${scripts_dir}/allele_freq.py ${vcfDir}/EW.${size}_NS.${size}_mig.${i}_N.${Ne}_n.${sampleSize}_${seed}.vcf ${outdir}/EW.${size}_NS.${size}_mig.${i}_N.${Ne}_n.${sampleSize}_${seed}_freq.png ${outdir}/EW.${size}_NS.${size}_mig.${i}_N.${Ne}_n.${sampleSize}_${seed}_freq.txt $size $size $sampleSize $Ne $i
